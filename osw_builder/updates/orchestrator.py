...
from .core import OSType, Update, build_ansible_inventory, create_search_playbook, parse_ubuntu_updates, parse_windows_updates
...
def search_updates(vagrant_dir: Path, os_type: OSType) -> List[Update]:
    ...
    result = run_ansible_playbook(inventory, playbook_config.content)
